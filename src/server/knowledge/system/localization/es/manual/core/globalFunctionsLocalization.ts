...
export const globalFunctionsLocalization: PbSystemSymbolLocalizationOverlay[] = [
    ...
    },
    {
        ...
        text: { summary: 'Devuelve TRUE si una cadena representa un valor numérico válido.' },
    },
    {
        locale: 'es', reviewed: false, source: 'manual-curated',
        targetKey: { domain: 'global-functions', kind: 'callable', namespace: 'powerscript', invocation: 'global', name: 'IsDate' },
        text: { summary: 'Devuelve TRUE si una cadena representa una fecha válida.' },
    },
    {
        locale: 'es', reviewed: false, source: 'manual-curated',
        targetKey: { domain: 'global-functions', kind: 'callable', namespace: 'powerscript', invocation: 'global', name: 'IsTime' },
        text: { summary: 'Devuelve TRUE si una cadena representa una hora válida.' },
    },
    {
        locale: 'es', reviewed: false, source: 'manual-curated',
    ...
    },
    {
        ...
        text: { summary: 'Elimina los espacios iniciales y finales.' },
    },
    {
        locale: 'es', reviewed: false, source: 'manual-curated',
