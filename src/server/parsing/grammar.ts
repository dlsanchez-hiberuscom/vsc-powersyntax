...
export const PB_BUILTIN_TYPES = new Set<string>([
  ...
  'adoresultset', 'arraybounds', 'batchdataobjects', 'connection', 'contextinformation', 'contextkeyword', 'datastore', 'dynamicdescriptionarea',
  'dynamicstagingarea', 'environment', 'errorlogging', 'message', 'mlsync', 'mlsynchronization', 'nonvisualobject', 'pipeline', 'powerserverresult',
  'resultset', 'syncparm', 'timing', 'transaction', 'transactionserver', 'ulsync',
  'mdiframe', 'mdiclient', 'menu', 'menucascade',
  'animation', 'checkbox', 'commandbutton', 'datepicker', 'dropdownlistbox', 'dropdownpicturelistbox', 'editmask',
  'graph', 'graxis', 'grdispattr', 'groupbox', 'hprogressbar', 'hscrollbar', 'htrackbar', 'inkedit', 'inkpicture', 'line', 'listbox',
  'listview', 'listviewitem', 'multilineedit', 'monthcalendar', 'oval', 'picture', 'picturebutton', 'picturehyperlink',
  'picturelistbox', 'powerserverlabel', 'radiobutton', 'rectangle', 'ribbonbar', 'ribbonitem', 'ribbonapplicationbuttonitem',
  'ribbonapplicationmenu', 'ribboncategoryitem', 'ribboncheckboxitem', 'ribboncomboboxitem', 'ribbongroupitem',
  'ribbonlargebuttonitem', 'ribbonmenu', 'ribbonmenuitem', 'ribbonpanelitem', 'ribbonsmallbuttonitem', 'ribbontabbuttonitem',
  'richtextedit', 'roundrectangle', 'singlelineedit', 'statichyperlink', 'statictext', 'tab', 'tabbedbar', 'treeview',
  'treeviewitem', 'userobject', 'vprogressbar', 'vscrollbar', 'vtrackbar', 'webbrowser', 'windowactivex',
  'coderobject', 'compressorobject', 'crypterobject', 'dotnetassembly', 'dotnetobject', 'errorlogging', 'exception', 'extractorobject',
  'httpclient', 'inet', 'internetresult', 'resourceresponse', 'mailfiledescription', 'mailmessage', 'mailrecipient', 'mailsession',
  'mimemessage', 'smtpclient', 'oauthclient', 'oauthrequest', 'jsonparser', 'jsongenerator', 'jsonpackage', 'filesystem',
  'profilecall', 'profileclass', 'profileline', 'profileroutine', 'profiling', 'traceactivitynode', 'tracebeginend', 'traceerror',
  'traceesql', 'tracefile', 'tracegarbagecollect', 'traceline', 'traceobject', 'traceroutine', 'tracetree', 'tracetreeerror',
  'tracetreeesql', 'tracetreegarbagecollect', 'tracetreeline', 'tracetreenode', 'tracetreeobject', 'tracetreeroutine', 'tracetreeuser',
  'traceuser', 'oletxnobject', 'pdfaction', 'pdfactionjavascript', 'pdfactionnamed', 'pdfactionresetform', 'pdfattachment', 'pdfcolor',
  'pdfcontent', 'pdfcontext', 'pdfdocextractor', 'pdfdocument', 'pdfdocumentproperties', 'pdffont', 'pdfformfield', 'pdfformfieldcheckbox',
  'pdfformfieldcombobox', 'pdfformfieldgroup', 'pdfformfieldlistbox', 'pdfformfieldpushbutton', 'pdfformfieldradiobutton',
  'pdfformfieldradiobuttongroup', 'pdfformfieldtext', 'pdfimage', 'pdfimportcontent', 'pdfinvisiblecontent', 'pdfmodel', 'pdfmultilinetext',
  'pdfobject', 'pdfpage', 'pdfrichtext', 'pdfsecurity', 'pdfsharedtext', 'pdftableofcontents', 'pdftableofcontentsitem', 'pdftext',
  'pdftextblock', 'pdftextlayout', 'pdfvisiblecontent', 'pdfwatermark', 'restclient', 'service', 'sslcallback', 'sslserviceprovider',
  'tokenrequest', 'tokenresponse', 'wsconnection',
  ...
  'message', 'environment', 'error', 'throwable', 'runtimeerror',
  'classdefinition', 'enumerationdefinition', 'enumerationitemdefinition', 'function_object', 'pbdom_characterdata',
  'pbdom_object', 'pbdom_text', 'scriptdefinition', 'simpletypedefinition', 'variablecardinalitydefinition', 'variabledefinition', 'typedefinition',
  'typeobject',
