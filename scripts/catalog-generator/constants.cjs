...
const POWERSCRIPT_RESERVED_WORDS_URL = `${POWERSCRIPT_BASE_URL}Reserved_words.html`;
const POWERSCRIPT_STATEMENTS_URL = `${POWERSCRIPT_BASE_URL}ch06.html`;
const POWERSCRIPT_ENUMERATED_DATATYPES_URL = `${POWERSCRIPT_BASE_URL}Enumerated_datatypes.html`;
const POWERSCRIPT_STANDARD_DATATYPES_URL = `${POWERSCRIPT_BASE_URL}Standard_datatypes.html`;
const POWERSCRIPT_EVENTS_URL = `${POWERSCRIPT_BASE_URL}ch08.html`;
...
const OBJECTS_AND_CONTROLS_PROPERTIES_URL = `${OBJECTS_AND_CONTROLS_BASE_URL}ch03.html`;
const OBJECTS_AND_CONTROLS_UNDOCUMENTED_BASE_CLASSES_URL = `${OBJECTS_AND_CONTROLS_BASE_URL}ch01s01.html`;
...
const DATAWINDOW_CONSTANTS_CHAPTER_URL = `${DATAWINDOW_BASE_URL}ch04.html`;
