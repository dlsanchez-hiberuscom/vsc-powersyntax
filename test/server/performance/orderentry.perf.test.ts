...
test('OrderEntry perf: discovery detecta el corpus real sin bloquear y encuentra suficiente superficie fuente', { skip: !hasOrderEntry() }, async () => {
...
test('OrderEntry perf: indexWorkspace completa cold y warm sobre el corpus real', { skip: !hasOrderEntry() }, async () => {
  const fs = new NodeFileSystem();
