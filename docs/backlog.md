...
01. B376 — Workspace check command and AI-readable validation report
02. B377 — Current object/class check command and AI-readable validation report
03. B371 — Catalog localization model and immutable overlay contract
04. B372 — DocumentationService locale-aware lazy resolver
05. B373 — Localized catalog consumers for hover, completion and signatureHelp
06. B374 — Spanish catalog localization authoring workflow and coverage gate
07. B375 — Generated localization compatibility with regenerated catalog IDs
